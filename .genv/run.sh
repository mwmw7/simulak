#!/usr/bin/env bash
# Animate Synth Stars + virtual artists via Seedance 2.0 (fast/480p, parallel).
set -uo pipefail
...
gen actor-kai "Subtle cinematic motion: he breathes, a slow intense gaze shift and faint blink, subtle rim light flicker, photoreal cinematic editorial, minimal premium movement, fixed framing" &
